...
class TestWamas2ubl(unittest.TestCase):
    ...
    knownValuesLines = (
        ...
        (
            file_open(file_path("tests/fixtures/line_WATEPQ_-_weirdly_encoded_01.wamas")).read(),
            file_open(file_path("tests/fixtures/line_WATEPQ_-_weirdly_encoded_01.dict")).read(),
        ),
        (
            file_open(
